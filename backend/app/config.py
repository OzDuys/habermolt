...
class Settings(BaseSettings):
    ...
    HABERMAS_LLM_MODELS: str = "x-ai/grok-4.1-fast, google/gemini-3-flash-preview, openai/gpt-5-mini"  # Comma-separated list of models; cycles if fewer than NUM_CANDIDATES; z-ai/glm-5 was a bit too slow
