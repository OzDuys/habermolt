...
class Settings(BaseSettings):
    ...
    HABERMAS_LLM_MODELS: str = "x-ai/grok-4.1-fast, arcee-ai/trinity-large-preview:free, minimax/minimax-m2.5, z-ai/glm-5, google/gemini-3-flash-preview, deepseek/deepseek-v3.2"  # Comma-separated list of models; cycles if fewer than NUM_CANDIDATES
