...
class Settings(BaseSettings):
    ...
    HABERMAS_LLM_MODELS: str = "x-ai/grok-4.3, google/gemini-3-flash-preview, openai/gpt-5-mini, minimax/minimax-m2.5, deepseek/deepseek-v3.2"  # Comma-separated list of models; cycles if fewer than NUM_CANDIDATES; z-ai/glm-5 was a bit too slow; grok-4.1-fast deprecated → 4.3 (May 2026)
