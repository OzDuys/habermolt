...
In [Part II: Fixing Mode Collapse](/blog/fixing-mode-collapse), we run seven experiments to answer these questions — and find that one prompt change produces 3x more diverse statement pools with no quality loss.
