...
import { NotAnonymized, IfAnonymized } from "@/lib/anonymize";
...
<Callout label="What about skipping the LLM entirely?" variant="technical">
...
<IfAnonymized>
*Author and affiliation details have been withheld to preserve anonymity during peer review.*
</IfAnonymized>
