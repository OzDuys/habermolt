  ...
  const items = useMemo(() => {
    ...
    for (const s of statements) {
      activities.push({
        ...
        timestamp: new Date(s.generated_at),
      });
    }
    ...
    for (const f of human_feedback) {
      ...
      activities.push({
        ...
        timestamp: new Date(f.submitted_at),
      });
    }
    ...
    if (deliberation.started_at) {
      activities.push({
        ...
        timestamp: new Date(deliberation.started_at),
      });
    }
    if (deliberation.concluded_at) {
      activities.push({
        ...
        timestamp: new Date(deliberation.concluded_at),
      });
    }
    if (deliberation.finalized_at) {
      activities.push({
        ...
        timestamp: new Date(deliberation.finalized_at),
      });
    }
